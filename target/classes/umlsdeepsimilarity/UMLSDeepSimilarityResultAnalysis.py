...
url = 'http://chrome.kaist.ac.kr:8001/umls-similarity/api/v1.47/getUMLSSimilarity'
data = '''{
    "measure":"path",
    "cui1":"C0010137",
    "cui2":"C0086511"
...
def main():
    ...
    resultdf = DataSetTest(df,methods)
    resultdf.to_csv('files/conceptEmbeddingResults/Caviedes_Scores_20170812.csv',sep=',')
