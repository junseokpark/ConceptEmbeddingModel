package edu.kaist.corus.nlp.examples;
...
public class GravesLSTMCharModellingExample {
    public static void main( String[] args ) throws Exception {
        ...
        //UiConnectionInfo connectionInfo = new UiConnectionInfo.Builder().setPort(9991).build();
        ...
        // Then add the StatsListner to collect this information from the network, as it trains
